...
from fi.service.market import utils

import json as _json
# import re as _re
# import sys as _sys

from fi.service.market import shared
...
class Ticker():
    ...
    def history(self, period="1mo", interval="1d",
        ...
        try:
            ...
            req1 = {"body":self.ticker}
            #
            resp = _requests.post("http://10.244.0.158:8000/fi/yfinance", data=_json.dumps(req1), headers=headers).text
            ...
            print(type(data))
            print(data)
            # data = session.post(url="http://127.0.0.1:31119/function/yfinance", data=self.ticker)
